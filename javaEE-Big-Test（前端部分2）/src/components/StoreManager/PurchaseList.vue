<template>
  <div>
      <el-table :data="purchaseList" class="yy-table" style="margin:30px auto;  width: 95%;height:550px">
        ...
        <el-table-column label="进货数量" prop="needgoodsnum">
<!--               
                <template slot-scope="scope"> 
                    <el-input-number size="mini" v-model="scope.row.needgoodsnum"></el-input-number>
            </template> -->
        </el-table-column>
    ...
    finish:function(index,row){
       ...
       var parma1 = {
         ...
         goodsnum:that.purchaseList[index].goodsnum,
           needgoodsnum:that.purchaseList[index].goodsnum
       }
       console.log(parma1)
       ...
       var parma2={
         ...
         goodsstorenum:that.purchaseList[index].goodsstorenum+that.purchaseList[index].needgoodsnum
        }
            console.log(parma2)
